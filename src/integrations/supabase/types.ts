...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_09aa4907_ff7d_452f_95ac_7030dc814f72: {
        Row: {
          body: Json | null
      ...
      log_events_22411d88_81b9_4040_a4fd_55430faec860: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_22cd729d_c064_4662_94c7_d4d14c7d06de: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_5e15c66b_941a_43a0_88e6_02ba4aa363fc: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_68e30aeb_7861_4c49_83b0_05829462a6eb: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_71bb6c02_3c97_4be5_be3e_c99fe6489e81: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_86ada63b_b1d1_4ce5_92f1_b615b79709b0: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_b98f4655_58ad_4943_b1cf_8b8e2330f92b: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_fce64a0e_d7fb_415c_82e8_9ef69c8fd380: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
  ...
  public: {
    Tables: {
      ...
      coletas: {
        Row: {
          ...
          galpao_id: string
          id: string
          mortalidade_canibalismo: number
          mortalidade_natural: number
          mortalidade_prolapso: number
          mortalidade_subita: number
          mortalidade_total: number | null
          ovos_quebrados: number
          ovos_sujos: number
          ovos_tipo_1: number
          ovos_tipo_2: number
          ovos_total: number
        ...
        Relationships: [
          {
            foreignKeyName: "coletas_galpao_id_fkey"
            columns: ["galpao_id"]
      ...
      eventos_sanitarios: {
        ...
        Relationships: [
          {
            foreignKeyName: "eventos_sanitarios_galpao_id_fkey"
            columns: ["galpao_id"]
            referencedRelation: "galpoes"
            referencedColumns: ["id"]
          },
      ...
      galpoes: {
        Row: {
          ...
          nome: string
          sistema: Database["public"]["Enums"]["sistema_alojamento"]
          updated_at: string
        }
        Insert: {
          area_util?: number | null
    ...
    Enums: {
      ...
      nivel_acesso: "admin" | "gerente" | "operador" | "leitura"
      sistema_alojamento: "GAIOLA" | "CAGE_FREE" | "ENRIQUECIDA"
      status_evento: "PENDENTE" | "REALIZADO" | "CANCELADO"
      tipo_evento_sanitario: "VACINACAO" | "MEDICACAO" | "DESINFECCAO" | "EXAME"
    }
    CompositeTypes: {
      [_ in never]: never
    }
