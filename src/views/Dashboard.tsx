      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className={`rounded-2xl border p-4 shadow-sm transition-colors
            ${cloud === 'online' ? 'bg-green-50 border-green-200' : cloud === 'error' ? 'bg-red-50 border-red-200' : 'bg-muted border-border'}`}>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-black text-xs text-foreground">
                  {cloud === 'online' ? 'Firebase Sincronizado' : cloud === 'error' ? 'Sem Sincronização' : 'Conectando...'}
                </p>
                <p className="text-[11px] text-muted-foreground">
                  {cloud === 'online' ? 'Dados em tempo real' : cloud === 'error' ? 'Verifique a internet' : 'Aguarde...'}
                </p>
              </div>
